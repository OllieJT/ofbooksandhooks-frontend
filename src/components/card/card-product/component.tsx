...
export const CardProduct = ({ title, subtitle, price, noteText, noteTheme = Theme.Blue, thumb, link }: CardProductProps) => {
		...
		<Wrapper url={link}>
			...
			{thumb && (
				<div className={style.thumb}>
					<Image src={thumb.url} width={thumb.width} height={thumb.height} alt={thumb.alt || title} />
				</div>
			)}
			{price && (
